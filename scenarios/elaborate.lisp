...
;;
;; Cycles tn-q0 + ag-tn-q0-0 through six 30-minute phases, exercising
...
(defun scenario-elaborate-baseline ()
  ...
  (set-aggressor-size "ag-tn-q0-0" 0.2)
...
(log.info "scenario-elaborate: armed against tn-q0 + ag-tn-q0-0 (3h)")
